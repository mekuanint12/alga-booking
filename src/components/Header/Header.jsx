  ...
  return (
    <div className="header">
        <div  className={type === "list" ? "headerContainer listMode" : "headerContainer"} >
            ...
            { type !== "list" && <> 
            <h1 className="headerTitle">A life time discount? It's Genius.</h1>
            <p className="headerDesc">
                Get reward for your travels - unlock instant savings of 10% or more with free AlgaBet Booking. 
            </p>
            <button className="headerBtn">Sign In / Register </button>
                ...
                <div className="headerSearch">
                    ...
                    <div onClick={() => setShowOpenDate(!showOpenDate)} className="headerSearchItem">
